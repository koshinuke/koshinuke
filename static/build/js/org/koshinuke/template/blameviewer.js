...
org.koshinuke.template.blameviewer.tmpl = function(opt_data, opt_sb) {
  ...
  output.append('<div class="metadata"><span class="commit">', soy.$$truncate(soy.$$escapeHtml(opt_data.commit), 10, false), '</span><span class="small ', soy.$$escapeHtml(opt_data.author), '">', soy.$$escapeHtml(opt_data.author), '</span><span class="calendar">', soy.$$escapeHtml(opt_data.timestamp), '</span><span class="comment">', soy.$$escapeHtml(opt_data.message), '</span></div>');
