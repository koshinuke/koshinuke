...
org.koshinuke.template.blameviewer.tmpl = function(opt_data, opt_sb) {
  ...
  output.append('<span class="commitdata"><span class="author"><img class="small ', soy.$$escapeHtml(opt_data.author), '"/>', soy.$$escapeHtml(opt_data.author), '</span>authored<span class="calendar">', soy.$$escapeHtml(opt_data.timestamp), '</span></span><div class="message">', soy.$$escapeHtml(opt_data.message), '</div>');
